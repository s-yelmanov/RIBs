...
```gradle
dependencies {
  annotationProcessor 'com.uber.rib:rib-compiler-test:0.13.2'
  implementation 'com.uber.rib:rib-android:0.13.2'
  testImplementation 'com.uber.rib:rib-test:0.13.2'
}
```
